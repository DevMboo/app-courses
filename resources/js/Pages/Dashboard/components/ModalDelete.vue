...
const handleSubmit = () => {
  form.post(`/payment/${props.buyingId}/destroy`, {
    onSuccess: () => {
      form.reset();
      closeModal();
    },
    ...
    <div v-if="isOpen" class="w-screen min-h-screen bg-[rgba(0,0,0,.5)] z-[1040] fixed top-0 left-0">
      <div class="w-full max-w-[420px] px-2 py-2 mx-auto bg-white rounded-lg my-16 relative">
        <div class="flex justify-between">
          <h1 class="text-xl">Tem certeza que deseja continuar?</h1>
        ...
        <form @submit.prevent="handleSubmit">
          <div class="py-2">
            ...
            <p class="text-center text-md font-semibold">Você está prestes a excluir este pagamento. Todos os registros vinculados a ele serão permanentemente apagados. Essa ação é irreversível. Deseja continuar?</p>
          </div>
