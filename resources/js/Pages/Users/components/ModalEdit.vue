...
watch(() => props.userId, (newUserId) => {
    if (newUserId) {
        axios.get(`/users/${newUserId}/details/edit`)
            .then((response) => {
                ...
                previewImage.value = user.avatar ? `storage/${user.avatar}` : 'images/default.webp';
...
const handleSubmit = () => {
    form.post(`/users/${props.userId}/details`, {
        onSuccess: () => {
            form.reset();
            closeModal();
        },
                            ...
                            <div class="grid grid-cols-6 gap-2">
                                ...
                                <div class="col-span-3">
                                    ...
                                    <input type="password" placeholder="" id="password" v-model="form.password"
                                        class="mr-2.5 mb-2 h-full max-h-[44px] w-full rounded-lg border border-zinc-200 bg-white px-4 py-3 text-sm font-medium text-zinc-950 placeholder:text-zinc-400 focus:outline-0 focus:ring-2 ring-blue-600">
                                    <div class="text-red-600 text-xs" v-if="form.errors.password">{{
                                ...
                                <div class="col-span-3">
                                    ...
                                    <input type="password" placeholder="" id="confirm_password"
                                        ...
                                        class="mr-2.5 mb-2 h-full max-h-[44px] w-full rounded-lg border border-zinc-200 bg-white px-4 py-3 text-sm font-medium text-zinc-950 placeholder:text-zinc-400 focus:outline-0 focus:ring-2 ring-blue-600">
                                    <div class="text-red-600 text-xs" v-if="form.errors.confirm_password">{{
