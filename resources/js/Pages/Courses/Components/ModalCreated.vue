    ...
    <div v-if="open" class="w-screen min-h-screen bg-[rgba(0,0,0,.5)] z-[1040] fixed top-0 left-0">
        <div class="w-full max-w-[820px] px-2 py-2 mx-auto bg-white rounded-lg my-16 relative">
            <div class="flex justify-between">
                <h1 class="text-xl font-semibold">Novo curso</h1>
                        ...
                        <div class="col-span-3">
                            ...
                            <div class="grid grid-cols-6 gap-2">
                                ...
                                <div class="col-span-3">
                                    ...
                                    <money3 v-model="form.price" v-bind="config" class="mr-2.5 mb-2 h-full max-h-[44px] w-full rounded-lg border border-zinc-200 bg-white px-4 py-3 text-sm font-medium text-zinc-950 placeholder:text-zinc-400 focus:outline-0 focus:ring-2 ring-blue-600"></money3>
                                ...
                                <div class="col-span-3">
                                    ...
                                    <div class="w-full flex">
                                        <input type="text" placeholder="Adicionar material" v-model="newMaterial"
                                            id="materials"
                                            class="mr-2.5 mb-2 h-full max-h-[44px] w-full rounded-lg border border-zinc-200 bg-white px-4 py-3 text-sm font-medium text-zinc-950 placeholder:text-zinc-400 focus:outline-0 focus:ring-2 ring-blue-600">
                                    ...
                                    <ul class="mt-2">
                                        <li v-for="(material, index) in form.materials" :key="index"
                                            ...
                                            <span>{{ material }}</span>
                                            <button @click="removeMaterial(index)" type="button"
