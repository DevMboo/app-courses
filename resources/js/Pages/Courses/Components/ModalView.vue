  ...
  <div v-if="isOpen" class="w-screen min-h-screen bg-[rgba(0,0,0,.5)] z-[1040] fixed top-0 left-0">
    <div class="w-full max-w-[820px] px-2 py-2 mx-auto bg-white rounded-lg my-16 relative">
      <div class="flex justify-between">
        <h1 class="text-xl font-semibold">Visualizar curso</h1>
          ...
          <div class="col-span-3">
            ...
            <div class="grid grid-cols-6 gap-2">
              <div class="col-span-3">
                ...
                <input disabled type="text" placeholder="" id="title" v-model="form.title"
              ...
              <div class="col-span-3">
                ...
                <select disabled name="category" id="category" v-model="form.category"
                  class="mr-2.5 mb-2 h-full max-h-[44px] w-full rounded-lg border border-zinc-200 bg-white px-4 py-3 text-sm font-medium text-zinc-950 placeholder:text-zinc-400 focus:outline-0 focus:ring-2 ring-blue-600">
              ...
              <div class="col-span-3">
                ...
                <input disabled type="text" placeholder="300" id="vacancies" v-model="form.vacancies"
                  class="mr-2.5 mb-2 h-full max-h-[44px] w-full rounded-lg border border-zinc-200 bg-white px-4 py-3 text-sm font-medium text-zinc-950 placeholder:text-zinc-400 focus:outline-0 focus:ring-2 ring-blue-600">
              </div>
              <div class="col-span-3">
                <label for="date_ini">Inscrições de*</label>
                <input disabled type="date" placeholder="08/10/2024" id="date_ini" v-model="form.date_ini"
                  class="mr-2.5 mb-2 h-full max-h-[44px] w-full rounded-lg border border-zinc-200 bg-white px-4 py-3 text-sm font-medium text-zinc-950 placeholder:text-zinc-400 focus:outline-0 focus:ring-2 ring-blue-600">
              </div>
              <div class="col-span-3">
                <label for="date_end">Até*</label>
                <input disabled type="date" placeholder="10/10/2024" id="date_end" v-model="form.date_end"
                  class="mr-2.5 mb-2 h-full max-h-[44px] w-full rounded-lg border border-zinc-200 bg-white px-4 py-3 text-sm font-medium text-zinc-950 placeholder:text-zinc-400 focus:outline-0 focus:ring-2 ring-blue-600">
              </div>
              ...
              <div class="col-span-6">
                ...
                <div class="inline-flex items-center gap-2">
                  <label class="flex items-center cursor-pointer relative">
                    <input disabled type="checkbox" checked v-model="form.status"
